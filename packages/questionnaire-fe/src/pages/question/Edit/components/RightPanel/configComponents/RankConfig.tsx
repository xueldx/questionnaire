...
const RankConfig: React.FC<RankConfigProps> = ({ componentId }) => {
  ...
  const getOptions = (): string[] => {
    ...
    return (currentComponent.props as QuestionRankPropsType).options || []
  }
  ...
  const addOption = () => {
    ...
    dispatch(
      updateComponentProps({
        fe_id: componentId,
        newProps: newProps as QuestionRankPropsType
      })
    )
  }
